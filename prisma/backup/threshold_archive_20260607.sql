...
\restrict 5tuLVXSpprm1y9ZCfNz0PhQqK5hr2AxGHRRAunajE3H3zpXxGFkzTjg2WoiDtHl
...
456	9	首席研究员	安娜·科瓦尔斯基博士	[ESIG-AK]	\N	档案撰写人	\N	2026-06-06 06:48:13.421
457	9	外勤行动部部长	亚历山大·科瓦尔部长	[ESIG-AK2]	\N	审阅批准	\N	2026-06-06 06:48:13.421
458	2	首席档案员	安雅·夏尔马	[ESIG-AS]	\N	地点档案撰写人	\N	2026-06-06 06:48:22.058
...
459	2	首席研究员	戴维·卡特博士	[ESIG-DC]	\N	审阅批准	\N	2026-06-06 06:48:22.058
460	5	部长	陈维华	ESIG-CW	\N	最终审核	52	2026-06-06 14:05:26.863
461	5	首席研究员	林知远	ESIG-LZ	\N	理论分析负责人	54	2026-06-06 14:05:26.863
466	1	总指挥	伊利亚·彼得连科	ESIG-IP	\N	审阅批准	51	2026-06-06 15:53:20.002
467	1	首席档案员	安雅·夏尔马	ESIG-AS	\N	威胁档案撰写人	53	2026-06-06 15:53:20.002
470	156	首席档案员	安雅·夏尔马	ESIG-AS	\N	威胁档案撰写人	53	2026-06-06 16:03:14.945
471	156	总指挥	伊利亚·彼得连科	ESIG-IP	\N	审阅批准	51	2026-06-06 16:03:14.945
\.
...
9	TMS-T0112	阈界档案	静默车站 (The Silent Station)	活跃	黄色-CP	黄色	\N	3	2	56	2026-06-06 06:48:13.421	3级	TMS-T0112记录阈界地点静默车站，一个位于城市地铁网络中的时间异常空间。该站台外表与正常地铁站无异，但站内所有计时设备永久锁定在23:47，且存在无法交互的"幽灵列车"现象。站台广播使用未知语言，疑似包含阈界坐标信息。	{时间冻结效应：停留超过23分钟的个体将出现主观时间感知与外界时间流逝的严重偏差,未知语言广播：包含疑似阈界坐标的编码信息，可能具有模因传播风险,幽灵列车异常：车窗内人影近期表现出对站台人员的感知行为，威胁等级可能上调}	{"phases": [{"name": "初始阶段", "target": "进入者", "duration": "0-23分钟", "mechanism": "个体无异常感知，计时设备显示23:47不变", "keyIndicator": "无", "manifestation": "无异常表现"}, {"name": "触发阶段", "target": "超时停留者", "duration": "23分钟", "mechanism": "个体进入\\"时间冻结\\"状态，外界观察其静止不动", "keyIndicator": "静止不动", "manifestation": "外界观察个体静止"}, {"name": "冻结阶段", "target": "冻结状态个体", "duration": "23分钟后", "mechanism": "个体主观时间正常流逝，可思考、感知环境，但无法移动或与外界交互", "keyIndicator": "主观时间感知异常", "manifestation": "外界每过1分钟，个体感知约10-30分钟"}, {"name": "恢复阶段", "target": "移出后的个体", "duration": "3-5分钟", "mechanism": "将个体移出站台后自行恢复", "keyIndicator": "恢复正常", "manifestation": "恢复正常状态"}], "protocols": [{"phase": "隔离", "measures": "站台入口封闭为\\"设施维修中\\"，设置常规施工围挡", "department": "外勤行动部", "procedureName": "区域封锁"}, {"phase": "监控", "measures": "24小时闭路监控，由Site-[数据删除]值班人员实时监视", "department": "安全与防护部", "procedureName": "实时监控"}, {"phase": "分流", "measures": "协调地铁运营方调整列车时刻表，该站不再停靠", "department": "联络与掩盖部门", "procedureName": "运营调整"}, {"phase": "预警", "measures": "进入人员佩戴计时器，22分钟时强制撤离", "department": "外勤行动部", "procedureName": "时间限制"}, {"phase": "研究", "measures": "单次进入时间不得超过22分钟，必须两人以上组队", "department": "档案与研究部", "procedureName": "受控实验"}], "commonName": "\\"23:47站台\\" (The Silent Station)", "leadPerson": "安娜·科瓦尔斯基博士", "properties": [{"name": "时间锁定", "scope": "站台内部空间", "category": "时间异常", "description": "站台内所有计时设备永久锁定在23:47，不受外部时间流逝影响"}, {"name": "时间冻结效应", "scope": "直接接触者", "category": "时间异常", "description": "停留超过23分钟的个体主观感知时间流速为外界的10-30倍"}, {"name": "幽灵列车", "scope": "站台区域", "category": "空间异常", "description": "列车按时到达但从不开启车门，车窗内存在无法交互的人影"}, {"name": "未知语言广播", "scope": "站台内部，录音可传播", "category": "认知危害", "description": "持续播报不属于任何已知语言谱系的语言，疑似包含阈界坐标"}, {"name": "坐标编码", "scope": "信息层面", "category": "信息异常", "description": "广播频谱分析发现嵌套的数字序列，指向深邃之海(TMS-L0735)区域"}], "coreFeatures": "时间锁定、时间冻结效应、幽灵列车、未知语言广播、坐标编码", "responseTeam": "快速反应小队\\"守夜人\\"", "anomalyReport": "地铁乘客报告\\"时间停止的站台\\"，多名目击者称站台上有人\\"像雕塑一样站着不动\\"", "archiveNature": "时间异常型阈界地点，表现为地铁站台形态的时间锁定空间", "knownEntities": [{"name": "幽灵列车人影", "type": "未知实体", "behavior": "在列车车窗内活动，近期开始表现出对站台人员的感知行为", "mechanism": "无法与站台人员建立任何形式的交互", "dangerLevel": "未知（正在评估）", "contactRecord": "2026-01-08首次记录到人影集体转头\\"注视\\"站台上的人员"}], "sourceDepartment": "外勤行动部 / 快速反应小队\\"守夜人\\"", "discoveryLocation": "城市地铁网络，线路[数据删除]", "threatAssessments": [{"riskLevel": "高", "personnelType": "长时间停留者", "recommendedAction": "严格限制停留时间，22分钟时强制撤离", "susceptibilityReason": "停留超过23分钟将触发时间冻结效应"}, {"riskLevel": "中", "personnelType": "广播录音接触者", "recommendedAction": "广播录音禁止带出研究区域", "susceptibilityReason": "广播可能具有模因传播风险"}], "accessRequirements": [{"text": "在22分钟限制内进行观测和记录", "allowed": true}, {"text": "使用便携式频谱分析设备采集广播数据", "allowed": true}, {"text": "任何人尝试与幽灵列车内人影进行任何形式的交互", "allowed": false}, {"text": "单次停留超过22分钟", "allowed": false}, {"text": "独自进入站台", "allowed": false}, {"text": "广播录音带出研究区域", "allowed": false}], "behaviorGuidelines": [{"text": "在22分钟限制内进行观测和记录", "allowed": true}, {"text": "使用便携式频谱分析设备采集广播数据", "allowed": true}, {"text": "两人以上组队进入", "allowed": true}, {"text": "任何人尝试与幽灵列车内人影进行任何形式的交互", "allowed": false}, {"text": "单次停留超过22分钟", "allowed": false}, {"text": "独自进入站台", "allowed": false}], "emergencyProcedures": [{"text": "立即撤离所有人员", "allowed": true}, {"text": "封锁站台入口", "allowed": true}, {"text": "通知安全与防护部", "allowed": true}, {"text": "任何人尝试与幽灵列车内人影进行任何形式的交互", "allowed": false}, {"text": "未经授权进入站台", "allowed": false}], "environmentFeatures": {"physical": ["时间状态：永久23:47，所有计时设备锁定", "温度：正常，约22°C，无异常波动", "照明：站台照明持续运行，亮度恒定", "电磁环境：常规设备可正常运行，但时间显示功能失效", "声学环境：持续广播，音量约60-70分贝"], "cognitive": ["未知语言广播：持续播报不属于任何已知语言谱系的语言", "时间冻结效应：停留超过23分钟触发主观时间感知异常", "幽灵列车现象：车窗内人影近期表现出对站台的感知行为"]}, "responsibleDepartment": "档案与研究部"}	亚历山大·科瓦尔部长 | [数据删除]	通过	幽灵列车人影的行为变化（2026-01-08）表明该异常的活性可能正在增强。建议将监控等级从C级提升至B级，并限制所有非必要进入。广播坐标与深邃之海的关联性需要跨部门联合调查。 —— 安娜·科瓦尔斯基	/api/v1/uploads/TMS-T0112.png	2026-05-28 09:35:57.093	\N			f	/api/v1/uploads/TMS-T0112.mp4	<?xml version="1.0" encoding="UTF-8"?>\n<svg id="_图层_1" data-name="图层 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">\n  <path d="M322.5,322.49v1403.01h65.34l394.71-193.02v-479.6h36.45v461.78l504.2-246.56h263.38l-359.75,457.4h498.68V322.49H322.5ZM782.55,452.01h36.45v312.77h-36.45v-312.77h0ZM1052.53,1023.99h-503.52v-230.33h503.52v230.33Z"/>\n  <g>\n    <path d="M592.98,884.08c-.05-.05-.09-.13-.09-.25,0-6.47,1.8-12.51,5.42-18.12,3.61-5.6,8.46-10.11,14.56-13.51s12.48-5.1,19.17-5.1,13.24,1.7,19.01,5.1,10.35,7.95,13.75,13.67c3.4,5.72,5.1,11.81,5.1,18.28,0,5.28-1.14,10.41-3.4,15.37s-5.88,10.35-10.84,16.18l-42.54,45.78v-10.35h57.92c.11,0,.18.03.25.09.05.05.09.14.09.25v17.15c0,.11-.03.16-.09.16h-75.95c-.11,0-.21-.05-.32-.16v-13.92c0-.11.02-.16.09-.16s.13-.05.25-.16l46.43-50.47c3.77-4.42,6.36-8,7.77-10.76s2.1-5.74,2.1-8.98c0-3.77-.8-7.15-2.43-10.11-1.62-2.97-3.88-5.26-6.79-6.88-2.91-1.62-6.36-2.42-10.35-2.42s-7.41.84-10.6,2.51c-3.18,1.67-5.72,3.96-7.61,6.88-1.89,2.91-2.77,6.15-2.67,9.71,0,.11-.11.21-.32.32h-17.63c-.11,0-.19-.02-.25-.09h-.01Z"/>\n    <path d="M717.95,911.33v-16.34c.21-.11.37-.16.48-.16,7.54.32,13.56-.86,18.04-3.56,4.48-2.69,6.72-6.42,6.72-11.16,0-3.02-.67-5.69-2.02-8s-3.27-4.12-5.74-5.42c-2.49-1.3-5.34-1.94-8.57-1.94-4.32,0-7.91.97-10.76,2.91-2.86,1.94-4.83,4.69-5.9,8.25v.16c-.11,0-.16.03-.16.09s-.05.09-.16.09h-18.12c-.21-.11-.27-.21-.16-.32.86-5.07,2.86-9.85,5.99-14.31,3.13-4.48,7.27-8,12.46-10.6,5.17-2.59,10.78-3.88,16.82-3.88s11.73,1.4,17.07,4.21,9.6,6.66,12.78,11.57,4.77,10.22,4.77,15.93-1.86,10.76-5.58,15.13c-3.72,4.37-8.82,7.79-15.29,10.27l-.16-3.24c8.95,2.15,15.82,5.9,20.62,11.24s7.2,12.27,7.2,20.78c0,6.58-1.86,12.76-5.58,18.52-3.72,5.77-8.71,10.38-14.97,13.83-6.26,3.45-12.83,5.17-19.73,5.17s-13.81-1.67-20.06-5.01c-6.26-3.34-11.27-7.87-15.04-13.58-3.77-5.71-5.67-11.86-5.67-18.44,0-.11.02-.16.09-.16h17.71c.11,0,.21.05.32.16,0,3.66.97,6.99,2.91,9.95,1.94,2.97,4.64,5.28,8.09,6.95s7.33,2.51,11.65,2.51,7.84-.86,11.24-2.59c3.4-1.72,6.04-4.09,7.93-7.11s2.83-6.42,2.83-10.19c0-7.11-2.67-12.59-8-16.42-5.34-3.82-13.19-5.53-23.54-5.1-.11.11-.27.05-.48-.16v-.03Z"/>\n    <path d="M792.92,866.02s.13-.09.25-.09h20.71c.11,0,.18.03.25.09.05.05.09.14.09.25v20.71c0,.11-.03.19-.09.25s-.14.09-.25.09h-20.71c-.11,0-.19-.02-.25-.09-.05-.05-.09-.13-.09-.25v-20.71c0-.11.02-.18.09-.25ZM792.92,930.32h21.19s.09.11.09.32v20.71c0,.11-.03.19-.09.25s-.14.09-.25.09h-20.71c-.11,0-.19-.02-.25-.09-.05-.05-.09-.13-.09-.25v-20.71c0-.21.02-.32.09-.32h.01Z"/>\n    <path d="M916.11,925.65v17.63c0,.05-.05.09-.16.09h-11.81v25.08c0,.21-.03.32-.09.32h-18.12c-.05,0-.09-.11-.09-.32v-25.08h-49.34c-.21,0-.32-.02-.32-.09v-13.35c0-.11.02-.16.09-.16s.09-.05.09-.16l51.44-80.56c0-.21.11-.27.32-.16h15.93s.09.11.09.32v76.35h11.81c.11,0,.16.03.16.09h0ZM885.85,925.73v-43.03l-26.86,43.03h26.86Z"/>\n    <path d="M961.72,968.77h-18.93c-.11,0-.19-.02-.25-.09-.05-.05-.03-.13.09-.25l44-101.91h-52.58c-.11,0-.16-.02-.16-.09v-17.55h74.57c.11,0,.16.11.16.32v12.13c0,.11-.03.16-.09.16s-.09.05-.09.16l-46.1,106.93c-.11.11-.32.16-.64.16v.02Z"/>\n  </g>\n</svg>
...
151	TMS-L0567	阈界档案	一神坠入 (The Falling God)	活跃	红色-O	红色	\N	3	2	54	2026-06-06 06:47:52.102	5级	TMS-L0567是一个基于地点/空间的阈界（大类：L），表现为一处古代天文观测台遗迹，位于[数据删除]高原地区。该阈界的核心异常为一个持续性的"神明坠落"现象：每当夜幕降临，观测台上空会出现一个巨大的人形轮廓，以极其缓慢的速度从星空中坠落。长时间观察会导致观察者产生强烈的宗教创伤，表现为对一切神圣概念的彻底质疑、精神支柱的崩塌，以及对"堕落"概念的病态迷恋。	{宗教创伤,认知污染,堕落迷恋症候群,信息污染}	{"phases": [{"name": "初始暴露", "target": "建立感知连接", "duration": "T+0-30min", "mechanism": "视觉接触触发", "keyIndicator": "瞳孔放大、心率升高", "manifestation": "目击坠落轮廓"}, {"name": "神性共鸣", "target": "建立情感连接", "duration": "T+30min-2h", "mechanism": "共情机制启动", "keyIndicator": "情绪波动、异常哭泣", "manifestation": "感受\\"神性失落\\""}, {"name": "遗言接收", "target": "传播认知污染", "duration": "T+2-4h", "mechanism": "信息污染传播", "keyIndicator": "语言异常、重复性行为", "manifestation": "\\"听到\\"神明遗言"}, {"name": "创伤固化", "target": "永久性认知改变", "duration": "T+4h+", "mechanism": "心理结构崩解", "keyIndicator": "信仰崩塌、堕落迷恋", "manifestation": "宗教创伤形成"}], "protocols": [{"phase": "日常", "measures": "日落至日出期间完全封锁", "department": "安全与防护部", "procedureName": "时间隔离"}, {"phase": "防护", "measures": "自动光学干扰系统", "department": "后勤与架构部", "procedureName": "视觉防护"}, {"phase": "筛选", "measures": "通过宗教创伤抗性测试", "department": "医疗与心理部", "procedureName": "人员筛选"}, {"phase": "应急", "measures": "\\"遗言\\"传播迹象检测与信息封锁", "department": "档案与研究部", "procedureName": "紧急响应"}, {"phase": "心理", "measures": "定期宗教创伤评估和治疗", "department": "医疗与心理部", "procedureName": "心理防护"}], "commonName": "一神坠入 / 神明坠落之地", "leadPerson": "林知远博士", "properties": [{"name": "古代天文观测台", "scope": "低", "category": "物理结构", "description": "圆形石质平台，中央有复杂星象图案"}, {"name": "坠落人形轮廓", "scope": "高", "category": "视觉异常", "description": "夜间出现巨大坠落人形轮廓，持续6-8小时"}, {"name": "宗教创伤", "scope": "极高", "category": "心理效应", "description": "神圣概念质疑、堕落迷恋症候群"}, {"name": "\\"神明遗言\\"传播", "scope": "极高", "category": "信息污染", "description": "包含现实结构质疑内容"}], "coreFeatures": "古代天文观测台遗迹，夜间出现巨大坠落人形轮廓，引发宗教创伤", "archiveNature": "基于地点/空间的阈界", "sourceDepartment": "外勤行动部 / 勘探队\\"伽马\\"", "discoveryLocation": "[数据删除]高原地区的古代天文观测台遗迹", "threatAssessments": [{"riskLevel": "极高", "personnelType": "有宗教信仰者", "recommendedAction": "禁止进入隔离区", "susceptibilityReason": "宗教背景增强共情"}, {"riskLevel": "高", "personnelType": "高共情能力者", "recommendedAction": "需通过宗教创伤抗性测试", "susceptibilityReason": "易受\\"神性失落\\"感染"}, {"riskLevel": "中", "personnelType": "精神不稳定者", "recommendedAction": "严格筛选，禁止夜间观察", "susceptibilityReason": "心理防线薄弱"}], "environmentFeatures": {"physical": ["古代天文观测台遗迹", "圆形石质平台", "中央星象图案"], "cognitive": ["神性失落感", "宗教创伤", "堕落迷恋"]}, "responsibleDepartment": "档案与研究部"}	林知远博士 | [数据删除]	通过	一神坠入(TMS-L0567)的"神明坠落"效应可能与全球性哲学模因相关，建议监控类似O类阈界。后续探索需由堡垒队执行。	/api/v1/uploads/TMS-L0567.png	2026-06-02 01:43:12.375	\N			f	/api/v1/uploads/TMS-L0567.mp4	<?xml version="1.0" encoding="UTF-8"?>\n<svg id="_图层_1" data-name="图层 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2048 2048">\n  <path d="M1118.69,478.59l-15.04-67.23-14.01-89.04h-8.92v928.48l-56.8-432.54-56.64,431.29V408.99l-.08.15v-86.82h-9l-14.01,89.04-15.15,67.74L249,1725.68h1550L1118.69,478.59ZM1151.38,1477.78c-1.22,2.38,1.26,2.68,2.92,1.72,8.97-2.91-24.35,21.95-24.35,29.26-2.7,5.11-5.24,10.54-7.49,15.83-1.03,5.15-2.81,9.83-4.98,14.54-3.1,5.95-6.57,11.71-11.59,15.95-2.28,2.7-3.19,6.48-5.44,9.27-4.64,6.99,1.45,5.39,5.69,4.79,1.93.37,3.23,2.09,5.16,2.12,2.28.14,3.21,2.53,4.05,4.57.91,2.11,3.4,2.81,3.79,5.3.87,7.09,4.15,5.14,2.74,13.67,2.1,4.59,1.31,7.17.11,12.1.24,4.14-2.17,7.4-3.94,10.95-1.81,4.64-4.76,8.36-8.05,11.81-5.82,6.14-14.73,11.09-22.72,8.9-4.06-.52-6.89-4.52-10.97-3.9-6.14,2.58-11.04,7.74-16.22,12.12-9.17,3.36-18.02,9.4-27.91,8.72-3.18-.73-6.65-1.45-9.95-1.46-8-1.26-15.65-5.13-22.5-9.48-4.1-3.04-6.66-8.18-10.8-11.16-2.91-2.12-6.42-.22-9.45-1.26-8.09-4.25-14.87-11.1-22.28-16.63-8.38-6.77-10.78-18.84-17.37-27.26-6.58-5.32-8.91-13.94-11.21-22.31-2.56-7.51-6.14-14.17-9.14-21.47-3.17-12.31-9.04-23.61-11.55-36.11-.26-7.49,1.52-15.07,3.17-22.56,2.01-17.89-.85-35.61.65-53.56.03-8.3.9-16.72,1.2-24.99-.38-5.51.81-11.14,2.08-16.61,1-7.47-4.13-13.39-5.32-20.24-.87-10.48-7.61-19.3-6.37-30.21.87-5.71,4.33-15.62,10.9-13.75,5.87,4.82,6.44,14.68,9.53,21.76.89,3.17,2.79,6.2,4.54,8.87,1.91,2.72,5.19,5.56,4.91,9.4-.17,4.08-3.12,6.73-5.28,9.78-4.14,7.91-1.66,17.55-.57,25.83,3.37,16.98,4.2,34.37,5.89,51.65,2.06,6.95,3.41,14.46,2.38,21.87-1.92,9.19-1.49,19.31,3.56,26.84,5.1,5.49,18.75,40.37,18.34,12.89.42-3.68-1.71-6.76-2.37-10.16-1.03-7.99-.68-16.38-.63-24.49.16-4.77,1.66-10.3,3.42-14.63,2.2-10.93,8.95-20.38,11.63-31.2,2.8-5.43,1.73-9.29,1.92-14.73,1.27-5.31,1.09-10.74,1.73-16.19,1.22-4.46.84-8.33,1.56-12.91.69-2.31.66-4.32.89-6.7,1.24-4.97,1.39-10.42,2.77-15.44.17-2.58.1-4.01.8-6.38,2.28-9.62,4.45-19.66,5.69-28.62-.93-6.38-2.44-12.96-2.96-19.54.91-4.04,2.83-8.42,3.59-12.54,1-6.31.13-12.77.63-19.02,1.89-6.73,3.82-15.46,10.64-17.83l.1-.02c10.19,2.41,3.71,24.67,4.22,32.95-.57,8.15,5.69,16.38,1.36,24.13-2.42,3.03-4.88,6.16-6.39,9.86-2.14,8.41-.25,17.51-.3,26.1.59,16.21,1.93,32.31,2.07,48.52,2.42,30.64-8.68,32.35-10.4,54.2-.18,8.62-.22,17.4,2.58,25.41.39,9.29,3.12,18.1,5.65,26.74,4.14,7.32,8.82,14.87,11.01,22.98,5.42,4.36,5.27,7.07,8.32,12.96,9.62,3.27,7.13,3.98,13.81,10.9,3.44,1.93,18.39-18.12,22.28-21.63,2.68-3.27,2.82-7.9,5.27-11.38,4.55-8.75,10-16.97,13.43-26.33,1.16-1.84,1.65-4.39,2.45-6.45,2.14-4.02,4.03-8.5,2.4-13.07.81-6.78,3.12-15.29,4.49-21.77.4-1.48,1.13-.13,1.4.62.81,1.89-.08,4.75.24,6.6,3.02,2.71,9.43-12.68,10.19-15.3,4.02-5.67,2.21,4.79.83,6.79-.86,7.04,5.61-4.37,6.56-5.77.82-1.57,2.95-1.61,2.57.5-.58,2.71-5.04,7.17-3.09,9.56,1.65.53,3.16-1.82,4.3-2.87,1.28-1.67,3.56-1.91,2.68.54-1.27,2.67-4.25,4.43-4.78,7.51-.03,3.37,5.39-2.84,4.92.26-5.49,7.76-12.21,14.73-17.6,22.61-2.57,5.04-3.61,10.47-5.41,15.99-2.26,4.82-2.03,10.17-3.12,15.25-1.43,6.59-4.72,12.65-6.9,18.95-4.02,6.83-6.34,14.7-10.77,21.27-1.87,2.17.28,8.97,3.05,7.39,4.84-6.63,11.75-11.25,17.74-16.36,8.35-5.62,9.15-10.87,14.92-18.66,9.43-12.48,19.39-25.49,25.3-40.24.64-4.08-.33-7,2.14-10.44,1.34-1.58,6.39-21.49,8.04-16.98.63,2.16-1.61,6.08-.92,8.17,3.1,1.1,5.64-4.78,7.77-6.78,2.15-1.75,5.36-11.06,7.62-10.09,2.23,2.74-5.11,10.39-2.65,11.99,3.36.05,7.99-12.69,10.56-7.7.27,2.56-9.76,10.84-4.29,11.19,1.9-.65,7.73-6.88,6.77-1.88-1.07,2.91-4.7,3.8-5.93,6.65Z"/>\n</svg>
...
SELECT pg_catalog.setval('public.archive_signatures_id_seq', 471, true);
...
\unrestrict 5tuLVXSpprm1y9ZCfNz0PhQqK5hr2AxGHRRAunajE3H3zpXxGFkzTjg2WoiDtHl
